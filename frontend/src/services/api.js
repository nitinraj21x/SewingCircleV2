...
export const projectsAPI = {
  ...
  addUpdate: (id, content) => api.post(`/projects/${id}/updates`, { content }),
  share: (id, userIds) => api.post(`/projects/${id}/share`, { userIds }),
  collaborate: (id, role) => api.post(`/projects/${id}/collaborate`, { role }),
};
...
export const adminAPI = {
  ...
  updateEvent: (id, eventData) => {
    ...
    Object.keys(eventData).forEach(key => {
      ...
      } else if (key === 'gallery' && Array.isArray(eventData[key])) {
        formData.append('gallery', JSON.stringify(eventData[key]));
  ...
  // Get single event with registrations (admin)
