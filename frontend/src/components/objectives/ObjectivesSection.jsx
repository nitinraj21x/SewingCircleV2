        ...
        <div className="objectives-grid">
          ...
          <Reveal delay={200}>
            <div className="card hover-purple">
              ...
              <div className="card-title">Building Empathy</div>
              </div>
          ...
          <Reveal delay={300}>
            <div className="card hover-blue">
              ...
              <div className="card-title">Strengthening Communities</div>
              </div>
          ...
          <Reveal delay={400}>
            <div className="card hover-yellow">
              ...
              <div className="card-title">Empowering Individuals</div>
              </div>
          ...
          <Reveal delay={500}>
            <div className="card hover-green">
              ...
              <div className="card-title">Creating Safe Spaces</div>
              </div>
